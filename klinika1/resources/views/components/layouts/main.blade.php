                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="{{route('appointment')}}" class="dropdown-item {{ request()->is('/') ? 'active' : '' }}">Uchrashuv</a>
                                <a href="{{route('features')}}" class="dropdown-item {{ request()->is('features') ? 'active' : '' }}">Xususiyatlar</a>
                                <a href="{{route('blog')}}" class="dropdown-item {{ request()->is('blog') ? 'active' : '' }}">Blog</a>
                                <a href="{{route('team')}}" class="dropdown-item {{ request()->is('team') ? 'active' : '' }}">Team</a>
                                <a href="{{route('testimonial')}}" class="dropdown-item {{ request()->is('testimonial') ? 'active' : '' }}">Testimonial</a>
                                <a href="{{route('error')}}" class="dropdown-item {{ request()->is('error') ? 'active' : '' }}">404 Page</a>
                            </div>
                        </div>
